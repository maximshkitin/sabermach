...
class ModelBlogPost extends Model {
	public function addPost($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "blog_post SET author = '" . $this->db->escape($data['author']) . "', sort_order = '" . (int)$data['sort_order'] . "', status = '" . (int)$data['status'] . "', popular = '" . (int)$data['popular'] . "', show_in_menu = '" . (int)$data['show_in_menu'] . "', date_added = NOW(), date_modified = NOW()");
	...
	public function editPost($blog_post_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "blog_post SET author = '" . $this->db->escape($data['author']) . "', sort_order = '" . (int)$data['sort_order'] . "', status = '" . (int)$data['status'] . "', popular = '" . (int)$data['popular'] . "', show_in_menu = '" . (int)$data['show_in_menu'] . "', date_modified = NOW() WHERE blog_post_id = '" . (int)$blog_post_id . "'");
