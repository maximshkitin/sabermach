...
class ModelSaleOrder extends Model {
	...
	public function changeTrakingCode($order_id, $code) {
		$this->db->query("UPDATE  `" . DB_PREFIX . "order` SET tracking_code = '" . $this->db->escape($code) . "' WHERE order_id = '" . (int)$order_id . "'");

		$query = $this->db->query("SELECT tracking_code FROM `" . DB_PREFIX . "order` WHERE order_id = '" . (int)$order_id . "'");
		$new_code = $query->row['tracking_code'];
