          ...
          <table id="option-value" class="table table-striped table-bordered table-hover">
            <thead>
              <tr>
                ...
                <td class="text-left">Big <?php echo $entry_image; ?></td>
            ...
            <tbody>
              ...
              <tr id="option-value-row<?php echo $option_value_row; ?>">
                ...
                <td class="text-left"><a href="" id="thumb-big-image<?php echo $option_value_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $option_value['big-thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="option_value[<?php echo $option_value_row; ?>][big_image]" value="<?php echo $option_value['big_image']; ?>" id="input-big-image<?php echo $option_value_row; ?>" /></td>
...
function addOptionValue() {
  ...
  html += '  <td class="text-left"><a href="" id="thumb-big-image' + option_value_row + '" data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="option_value[' + option_value_row + '][big_image]" value="" id="input-big-image' + option_value_row + '" /></td>';
