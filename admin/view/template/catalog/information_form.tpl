        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-information" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-date-updated"><?php echo $entry_last_updated; ?></label>
                <div class="col-sm-3">
                  <div class="input-group datetime">
                    <input type="text" name="date_updated" value="<?php echo $date_updated; ?>" placeholder="<?php echo $entry_last_updated; ?>" data-date-format="YYYY-MM-DD HH:mm" id="input-date-updated" class="form-control" />
