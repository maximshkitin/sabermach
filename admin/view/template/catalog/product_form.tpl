          ...
          <div class="tab-content">
                ...
                <table id="images" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      ...
                      <td class="text-left"><?php echo $entry_additional_hilt ?></td>
                  ...
                  <tbody>
                    ...
                    <tr id="image-row<?php echo $image_row; ?>">
                      ...
                      <td class="text-right">
                      <?php if(!empty($hilt_options)) : ?>
                        <select name="product_image[<?php echo $image_row; ?>][hilt_option_id]" class="form-control" />
                            <?php foreach ($hilt_options as $hilt): ?>
                              <option <?php if($product_image['hilt_option_id'] == $hilt['option_value_id']) echo 'selected'; ?> value="<?php echo $hilt['option_value_id']; ?>"><?php echo $hilt['name'] ?></option>
                            <?php endforeach; ?>
                        </select>
                      <?php else: ?>
                        <p>No available hilts</p>
                      <?php endif; ?>
                      </td>
            ...
            <div class="tab-pane" id="tab-other">
              <ul class="nav nav-tabs" id="language-other">
                <?php foreach ($languages as $language) { ?>
                <li><a href="#language-other<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                <?php } ?>
              </ul>
              <div class="tab-content">
                <?php $frow = 0; ?>
                <?php foreach ($languages as $language) { ?>
                <div class="tab-pane" id="language-other<?php echo $language['language_id']; ?>">
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-name<?php echo $language['language_id']; ?>"><?php echo $entry_subheading; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][features_subheading]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['features_subheading'] : ''; ?>" placeholder="<?php echo $entry_subheading; ?>" id="input-name<?php echo $language['language_id']; ?>" class="form-control" />
                      <?php if (isset($error_name[$language['language_id']])) { ?>
                      <div class="text-danger"><?php echo $error_name[$language['language_id']]; ?></div>
                      <?php } ?>
                    </div>
                    ...
                    <table id="features-items-<?php echo $language['language_id']; ?>" class="table table-striped table-bordered table-hover textarea-full-height">
                      <thead>
                        <tr>
                          <td class="text-left"><?php echo $entry_image; ?></td>
                          <td class="text-left"><?php echo $entry_item_title; ?></td>
                          <td class="text-left"><?php echo $entry_description; ?></td>
                          <td></td>
                        </tr>
                      </thead>
                      <tbody>
                        <?php if (isset($product_description[$language['language_id']]['features_items'])) { ?>
                        <?php foreach ($product_description[$language['language_id']]['features_items'] as $item) { ?>
                        <tr id="features-row<?php echo $frow; ?>">
                          <td class="text-left" style="width: 15%;">
                            <a href="" id="features-thumb-image-<?php echo $language['language_id']; ?>-<?php echo $frow; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['features_items'][$frow]['thumb'] : ''; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                            <input type="hidden" name="product_description[<?php echo $language['language_id']; ?>][features_items][<?php echo $frow; ?>][image]" value="<?php echo $item['image']; ?>" id="input-features-image-<?php echo $language['language_id']; ?>-<?php echo $frow; ?>" placeholder="<?php echo $entry_item_title; ?>" />
                          </td>
                          <td class="text-left" style="width: 25%;">
                            <input type="text" name="product_description[<?php echo $language['language_id']; ?>][features_items][<?php echo $frow; ?>][title]" value="<?php echo $item['title']; ?>" placeholder="<?php echo $entry_title; ?>" class="form-control" />
                          </td>
                          <td class="text-left" style="width: 50%;">
                            <textarea name="product_description[<?php echo $language['language_id']; ?>][features_items][<?php echo $frow; ?>][description]" placeholder="<?php echo $entry_description; ?>" class="form-control"><?php echo $item['description']; ?></textarea>
                          </td>
                          <td class="text-left">
                            <button type="button" onclick="$('#features-row<?php echo $frow; ?>, .tooltip').remove();" data-toggle="tooltip" title="<?php echo $text_remove_row; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button>
                          </td>
                        </tr>
                        <?php $frow++; ?>
                        <?php } ?>
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-description<?php echo $language['language_id']; ?>"><?php echo $entry_technical_specification_description; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][technical_specification_description]" placeholder="<?php echo $entry_description; ?>" id="input-technical_specification_description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['technical_specification_description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="included-input-image"><?php echo $entry_included_image; ?></label>
                    <div class="col-sm-10"><a href="" id="included-thumb-image<?php echo $language['language_id']; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['thumb'] : ''; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                      <input type="hidden" name="product_description[<?php echo $language['language_id']; ?>][included_image]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['included_image'] : ''; ?>" id="included-input-image<?php echo $language['language_id']; ?>" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-included_description<?php echo $language['language_id']; ?>"><?php echo $entry_included_description; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][included_description]" placeholder="<?php echo $entry_description; ?>" id="input-included_description<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['included_description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-included_items<?php echo $language['language_id']; ?>"><?php echo $entry_included_items; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][included_items]" placeholder="<?php echo $entry_included_items; ?>" id="input-included_items<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['included_items'] : ''; ?></textarea>
                    </div>
                  </div>
                </div>
                <?php } ?>
...
function addImage() {
  ...
  <?php if(!empty($hilt_options)) : ?>
  html += '<select name="product_image[' + image_row + '][hilt_option_id]" class="form-control">';
  <?php foreach ($hilt_options as $hilt): ?>
  html += '<option value="<?php echo $hilt['option_value_id']; ?>"><?php echo $hilt['name'] ?></option>';
  <?php endforeach; ?>
  html += '</select>';
  <?php else: ?>
  html += '<p>No available hilts</p>';
  <?php endif; ?>
  html += '</td>';
...
//--></script>
  <script type="text/javascript"><!--
var row = <?php echo $frow; ?>;
function addRow(language_id) {
  html  = '<tr id="features-row' + row + '">';
  html += '<td class="text-left" style="width: 15%;"><a href="" id="features-thumb-image-' + language_id + '-' + row + '" data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="product_description[' + language_id + '][features_items][' + row + '][image]" value="" id="input-features-image-' + language_id + '-' + row + '" /></td>';  
  html += '  <td class="text-left" style="width: 20%;"><input type="text" name="product_description[' + language_id + '][features_items][' + row + '][title]" value="" placeholder="<?php echo $entry_item_title; ?>" class="form-control" /></td>';  
  html += '  <td class="text-left" style="width: 50%;"><textarea name="product_description[' + language_id + '][features_items][' + row + '][description]" placeholder="<?php echo $entry_description; ?>" class="form-control"></textarea></td>';  
  html += '  <td class="text-left"><button type="button" onclick="$(\'#features-row' + row  + ', .tooltip\').remove();" data-toggle="tooltip" title="<?php echo $text_remove_row; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
  html += '</tr>';
  
  $('#features-items-' + language_id + ' tbody').append(html);
...
$('#language-other a:first').tab('show');
