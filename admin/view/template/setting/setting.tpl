      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-contact-form" data-toggle="tab">KB Form</a></li>
            <li><a href="#tab-email-messages" data-toggle="tab">Messages</a></li>
          </ul>
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  ...
                  <?php if ($error_slogan) { ?>
                  <div class="text-danger"><?php echo $error_slogan; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-help-email"><?php echo $entry_help_email; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_help_email" value="<?php echo $config_help_email; ?>" placeholder="<?php echo $entry_help_email; ?>" id="input-help-email" class="form-control" />
                  <?php if ($error_help_email) { ?>
                  <div class="text-danger"><?php echo $error_help_email; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-help-telephone"><?php echo $entry_help_phone; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_help_phone" value="<?php echo $config_help_phone; ?>" placeholder="<?php echo $entry_help_phone; ?>" id="input-help-telephone" class="form-control" />
                  <?php if ($error_help_phone) { ?>
                  <div class="text-danger"><?php echo $error_help_phone; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-social">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <?php if ($error_fb) { ?>
                  <div class="text-danger"><?php echo $error_fb; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-tw"><?php echo $entry_tw; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_tw" value="<?php echo $config_tw; ?>" placeholder="<?php echo $entry_tw; ?>" id="input-tw" class="form-control" />
                  <?php if ($error_tw) { ?>
                  <div class="text-danger"><?php echo $error_tw; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="config_in" value="<?php echo $config_in; ?>" placeholder="<?php echo $entry_in; ?>" id="input-in" class="form-control" />
                  <?php if ($error_in) { ?>
                  <div class="text-danger"><?php echo $error_in; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-yt"><?php echo $entry_yt; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_yt" value="<?php echo $config_yt; ?>" placeholder="<?php echo $entry_yt; ?>" id="input-yt" class="form-control" />
                  <?php if ($error_yt) { ?>
                  <div class="text-danger"><?php echo $error_yt; ?></div>
                  <?php } ?>
                </div>
              </div>
            </div>
            <div class="tab-pane" id="tab-contact-form">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-kb-subjects">Subjects</label>
                <div class="col-sm-10">
                  <textarea class="form-control" name="config_kb_subjects" id="input-kb-subjects"><?php echo $config_kb_subjects; ?></textarea>
                </div>
              </div>
            </div>
            <div class="tab-pane" id="tab-email-messages">
            <div class="form-group">
                <label class="col-sm-2 control-label" for="input-config_sms_new_order">New Order SMS</label>
                <div class="col-sm-10">
                  <textarea class="form-control" name="config_sms_new_order" id="input-config_sms_new_order"><?php echo $config_sms_new_order; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-contacts-message">Contacts Message</label>
                <div class="col-sm-10">
                  <textarea class="form-control redactor" name="config_contacts_message" id="input-kb-message"><?php echo $config_contacts_message; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-kb-message">Knowledge Base Message</label>
                <div class="col-sm-10">
                  <textarea class="form-control redactor" name="config_kb_message" id="input-kb-message"><?php echo $config_kb_message; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-config_review_mail">Discussion Board Message</label>
                <div class="col-sm-10">
                  <textarea class="form-control redactor" name="config_review_mail" id="input-config_review_mail"><?php echo $config_review_mail; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-config_forgottent_msg">Forgotten password</label>
                <div class="col-sm-10">
                  <textarea class="form-control redactor" name="config_forgottent_msg" id="input-config_forgottent_msg"><?php echo $config_forgottent_msg; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-config_new_customer_msg">Customer registration</label>
                <div class="col-sm-10">
                  <textarea class="form-control redactor" name="config_new_customer_msg" id="input-config_new_customer_msg"><?php echo $config_new_customer_msg; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-config_new_customer_msg_admin">Customer registration (for Admin)</label>
                <div class="col-sm-10">
                  <textarea class="form-control redactor" name="config_new_customer_msg_admin" id="input-config_new_customer_msg_admin"><?php echo $config_new_customer_msg_admin; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-config_new_order_msg">New order</label>
                <div class="col-sm-10">
                  <textarea class="form-control redactor" name="config_new_order_msg" id="input-config_new_order_msg"><?php echo $config_new_order_msg; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-config_new_order_msg_admin">New order (for Admin)</label>
                <div class="col-sm-10">
                  <textarea class="form-control redactor" name="config_new_order_msg_admin" id="input-config_new_order_msg_admin"><?php echo $config_new_order_msg_admin; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-config_update_order_msg">Update order</label>
                <div class="col-sm-10">
                  <textarea class="form-control redactor" name="config_update_order_msg" id="input-config_update_order_msg"><?php echo $config_update_order_msg; ?></textarea>
                </div>
              </div>
