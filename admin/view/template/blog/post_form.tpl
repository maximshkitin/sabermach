              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <textarea name="post_description[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="input-description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($post_description[$language['language_id']]) ? $post_description[$language['language_id']]['description'] : ''; ?></textarea>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="post_description[<?php echo $language['language_id']; ?>][tag]" value="<?php echo isset($post_description[$language['language_id']]) ? $post_description[$language['language_id']]['tag'] : ''; ?>" placeholder="<?php echo $entry_tag; ?>" id="input-tag<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                </div>
                <?php } ?>
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="blog_post-category" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($blog_post_categories as $blog_post_category) { ?>
                    <div id="blog_post-category<?php echo $blog_post_category['blog_category_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $blog_post_category['name']; ?>
                      <input type="hidden" name="blog_post_category[]" value="<?php echo $blog_post_category['blog_category_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-popular">Popular</label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-show_in_menu">Show in menu</label>
                <div class="col-sm-10">
                  <select name="show_in_menu" id="input-show_in_menu" class="form-control">
                    <?php if ($show_in_menu) { ?>
                    <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                    <option value="0"><?php echo $text_disabled; ?></option>
                    <?php } else { ?>
...
$('input[name=\'category\']').autocomplete({
  ...
  'select': function(item) {
    ...
    $('#blog_post-category' + item['value']).remove();
    
    $('#blog_post-category').append('<div id="blog_post-category' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="blog_post_category[]" value="' + item['value'] + '" /></div>'); 
  }
});

$('#blog_post-category').delegate('.fa-minus-circle', 'click', function() {
  $(this).parent().remove();
});  
//--></script> 
<script type="text/javascript"><!--
