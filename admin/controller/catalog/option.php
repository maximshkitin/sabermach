...
class ControllerCatalogOption extends Controller {
	...
	protected function getForm() {
		...
		foreach ($option_values as $option_value) {
			...
			if (is_file(DIR_IMAGE . $option_value['big_image'])) {
				$big_image = $option_value['big_image'];
				$big_thumb = $option_value['big_image'];
			} else {
				$big_image = '';
				$big_thumb = 'no_image.png';
			}
			...
			$data['option_values'][] = array(
				...
				'big_image'                => $big_image,
				'big-thumb'                => $this->model_tool_image->resize($big_thumb, 100, 100),
