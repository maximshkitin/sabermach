...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_tw'] = $this->language->get('entry_tw');
		$data['entry_in'] = $this->language->get('entry_in');
		$data['entry_yt'] = $this->language->get('entry_yt');
		$data['entry_help_email'] = $this->language->get('entry_help_email');
		$data['entry_help_phone'] = $this->language->get('entry_help_phone');
		...
		if (isset($this->error['help_email'])) {
			$data['error_help_email'] = $this->error['help_email'];
		} else {
			$data['error_help_email'] = '';
		}

		if (isset($this->error['help_phonel'])) {
			$data['error_help_phone'] = $this->error['help_phone'];
		} else {
			$data['error_help_phone'] = '';
		}
		...
		if (isset($this->error['tw'])) {
			$data['error_tw'] = $this->error['tw'];
		} else {
			$data['error_tw'] = '';
		}

		if (isset($this->error['in'])) {
			$data['error_in'] = $this->error['in'];
		} else {
			$data['error_in'] = '';
		}

		if (isset($this->error['yt'])) {
			$data['error_yt'] = $this->error['yt'];
		} else {
			$data['error_yt'] = '';
		}
		...
		if (isset($this->request->post['config_tw'])) {
			$data['config_tw'] = $this->request->post['config_tw'];
		} else {
			$data['config_tw'] = $this->config->get('config_tw');
		}

		if (isset($this->request->post['config_yt'])) {
			$data['config_yt'] = $this->request->post['config_yt'];
		} else {
			$data['config_yt'] = $this->config->get('config_yt');
		}

		if (isset($this->request->post['config_help_phone'])) {
			$data['config_help_phone'] = $this->request->post['config_help_phone'];
		} else {
			$data['config_help_phone'] = $this->config->get('config_help_phone');
		}

		if (isset($this->request->post['config_help_email'])) {
			$data['config_help_email'] = $this->request->post['config_help_email'];
		} else {
			$data['config_help_email'] = $this->config->get('config_help_email');
		}

		if (isset($this->request->post['config_kb_subjects'])) {
			$data['config_kb_subjects'] = $this->request->post['config_kb_subjects'];
		} else {
			$data['config_kb_subjects'] = $this->config->get('config_kb_subjects');
		}

		if (isset($this->request->post['config_contacts_message'])) {
			$data['config_contacts_message'] = $this->request->post['config_contacts_message'];
		} else {
			$data['config_contacts_message'] = $this->config->get('config_contacts_message');
		}

		if (isset($this->request->post['config_kb_message'])) {
			$data['config_kb_message'] = $this->request->post['config_kb_message'];
		} else {
			$data['config_kb_message'] = $this->config->get('config_kb_message');
		}
		...
		if (isset($this->request->post['config_forgottent_msg'])) {
			$data['config_forgottent_msg'] = $this->request->post['config_forgottent_msg'];
		} else {
			$data['config_forgottent_msg'] = $this->config->get('config_forgottent_msg');
		}
		
		if (isset($this->request->post['config_new_customer_msg'])) {
			$data['config_new_customer_msg'] = $this->request->post['config_new_customer_msg'];
		} else {
			$data['config_new_customer_msg'] = $this->config->get('config_new_customer_msg');
		}
		
		if (isset($this->request->post['config_new_customer_msg_admin'])) {
			$data['config_new_customer_msg_admin'] = $this->request->post['config_new_customer_msg_admin'];
		} else {
			$data['config_new_customer_msg_admin'] = $this->config->get('config_new_customer_msg_admin');
		}
	
		if (isset($this->request->post['config_new_order_msg'])) {
			$data['config_new_order_msg'] = $this->request->post['config_new_order_msg'];
		} else {
			$data['config_new_order_msg'] = $this->config->get('config_new_order_msg');
		}

		if (isset($this->request->post['config_new_order_msg_admin'])) {
			$data['config_new_order_msg_admin'] = $this->request->post['config_new_order_msg_admin'];
		} else {
			$data['config_new_order_msg_admin'] = $this->config->get('config_new_order_msg_admin');
		}

		if (isset($this->request->post['config_update_order_msg'])) {
			$data['config_update_order_msg'] = $this->request->post['config_update_order_msg'];
		} else {
			$data['config_update_order_msg'] = $this->config->get('config_update_order_msg');
		}

		if (isset($this->request->post['config_sms_new_order'])) {
			$data['config_sms_new_order'] = $this->request->post['config_sms_new_order'];
		} else {
			$data['config_sms_new_order'] = $this->config->get('config_sms_new_order');
		}
	...
	protected function validate() {
		...
		if (!$this->request->post['config_slogan']) {
			$this->error['slogan'] = $this->language->get('error_name');
		}
		...
		if ((utf8_strlen($this->request->post['config_help_email']) > 96) || !filter_var($this->request->post['config_help_email'], FILTER_VALIDATE_EMAIL)) {
			$this->error['config_help_email'] = $this->language->get('error_help_email');
		}

		if ((utf8_strlen($this->request->post['config_help_phone']) < 3) || (utf8_strlen($this->request->post['config_help_phone']) > 32)) {
			$this->error['config_help_phone'] = $this->language->get('error_help_phone');
		}
