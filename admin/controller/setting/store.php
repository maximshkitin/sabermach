...
class ControllerSettingStore extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['help_email'])) {
			$data['help_email'] = $this->request->post['help_email'];
		} elseif (isset($store_info['help_email'])) {
			$data['help_email'] = $store_info['help_email'];
		} else {
			$data['help_email'] = '';
		}

		if (isset($this->request->post['help_phone'])) {
			$data['help_phone'] = $this->request->post['help_phone'];
		} elseif (isset($store_info['help_phone'])) {
			$data['help_phone'] = $store_info['help_phone'];
		} else {
			$data['help_phone'] = '';
		}
	...
	protected function validateForm() {
		...
		if (!$this->request->post['config_slogan']) {
			$this->error['slogan'] = $this->language->get('error_slogan');
		}
		...
		if ((utf8_strlen($this->request->post['help_email']) > 96) || !filter_var($this->request->post['help_email'], FILTER_VALIDATE_EMAIL)) {
			$this->error['help_email'] = $this->language->get('error_help_email');
		}

		if ((utf8_strlen($this->request->post['help_phone']) < 3) || (utf8_strlen($this->request->post['help_phone']) > 32)) {
			$this->error['help_phone'] = $this->language->get('error_help_phone');
		}
