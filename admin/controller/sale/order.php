...
class ControllerSaleOrder extends Controller {
	...
	public function info() {
		...
		if ($order_info) {
			...
			$data['tracking_code_action'] = $this->url->link('sale/order/tcode', 'token=' . $this->session->data['token']. '&order_id=' . (int)$this->request->get['order_id'], true);
	...
	public function tcode() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {
			...
			if(empty($order_id) || empty($order_info)) {
				...
				$result = $this->model_sale_order->changeTrakingCode($order_id, $this->request->post['tracking_code']);
				$json['success'] = $result;
				$json['message'] = 'Tracking code saved';
			}
