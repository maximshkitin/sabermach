...
class ControllerCommonFooter extends Controller {
	public function index() {
		...
		$data['text_policies'] = $this->language->get('text_policies');
		...
		$data['policies'] = $this->url->link('information/information', 'information_id=3');
		...
		$data['discussion'] = $this->url->link('testimonial/testimonial', '', true);

		$data['name'] = $this->config->get('config_name');
		$data['back_to_top'] = $this->language->get('text_back_to_top');
