...
class ControllerCheckoutGuest extends Controller {
	public function index() {
		...
		} elseif (isset($this->session->data['customer_group_id'])) {
		...
		} elseif (isset($this->session->data['firstname'])) {
		...
		} elseif (isset($this->session->data['lastname'])) {
		...
		} elseif (isset($this->session->data['telephone'])) {
	...
	public function save() {
		...
		if ($this->customer->isLogged()) {
			$json['redirect'] = $this->url->link('checkout/checkout111', '', true);
		}
		...
		if (!$this->config->get('config_checkout_guest') || $this->config->get('config_customer_price')) {
			$json['redirect'] = $this->url->link('checkout/checkout222', '', true);
		}
