		...
		if (!$json) {
			if (isset($this->request->post['payment_address']) && $this->request->post['payment_address'] == 'existing') {
				...
				if (!$json) {
					...
					$this->session->data['payment_address'] = $this->model_account_address->getAddress($this->request->post['address_id'], 0);
				...
				if (!$json) {
					...
					if($this->customer->isLogged()) {
						$address_id = $this->model_account_address->getAddress(null, 0);
						if(!empty($address_id)) {
					...
					$this->session->data['payment_address'] = $this->model_account_address->getAddress($address_id, 0);
