...
class ControllerAccountAccount extends Controller {
	public function index() {
		...
		$data['active_total'] = $this->model_account_order->getTotalOrders(array(9, 13, 1, 15, 12));
		$data['unpaid_total'] = $this->model_account_order->getTotalOrders(array(7, 8, 10));
		$data['past_total'] = $this->model_account_order->getTotalOrders(array(5, 14, 15, 11, 16, 3));
