...
class ControllerAccountEdit extends Controller {
	...
	public function index() {
		...
		$this->response->setOutput($this->load->view('account/edit_index', $data));
	}
	...
	public function profile() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('account/edit/profile', '', true)
		);
		...
		$data['action'] = $this->url->link('account/edit/profile', '', true);
