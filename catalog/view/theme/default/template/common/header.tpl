      ...
      <div id="logo">
        ...
        <div id="main-nav">
          <nav>
			...
			<?php if ($products) : ?>
                <ul class="clearfix">
				<?php if($products['first']) : ?>
					<?php foreach ($products['first'] as $first) : ?>
			                <li>
                    ...
                    <a href="javascript:void(0);">Premium<br>
                      ...
                      <ul class="clearfix">
                      	<?php foreach ($products['second'] as $second) : ?>
	                        <li>
	                          <a href="<?php echo $second['href']; ?>">
			                	<?php if(count($second['name']) > 1) :?>
			                	  <?php echo reset($second['name']);?><br />
			                	  <span><?php echo end($second['name']);?></span>
			                	  <i class="fa fa-chevron-right"></i>
			                	<?php else :?>
			                	  <?php echo reset($second['name']);?>
			                	<?php endif;?>
			                	</a>
	                        </li>
                      	<?php endforeach; ?>
			...
			<?php endif; ?>
              ...
              <li class="dd-menu">
                ...
                <ul class="clearfix">
                  ...
                  <li>
                    <a href="http://staging.sabermach.com/store">
