<fieldset id="shipping-address" class="shipping-address">
  ...
  <div class="input-wrap">
    ...
    <div class="input-2">
      ...
      <select name="shipping-region" id="shipping-region"></select>
    </div>
  </div>
  <div class="input-wrap">
    <label for="shipping-address">Shipping-Address</label>
    <input type="text" name="address_1" value="<?php echo $shipping_address_1;?>" id="shipping-address">
  </div>
  <div class="input-wrap">
    <label for="shipping-post-code">Post Code</label>
    <input type="text" name="postcode" value="<?php echo $shipping_postcode;?>" class="only-numbers" id="shipping-post-code">
  </div>
</div>
  <div class="form-note">
