(function(){
	...
	.add([
		...
		TweenMax.to("#intro .saber-image", 0.1, {y:-270, scale: 1.2}),
	...
	.add([
		TweenMax.to("#why .why-intro", 0.1, {x: '-100%'}),
		TweenMax.to("#why .why-list", 0.1, {x:0}),
		TweenMax.to("#intro .saber-image", 0.1, {x:'-20%'}),
		TweenMax.to("#why .do-action-text", 0.1, {x:'-20%'})
	]);
